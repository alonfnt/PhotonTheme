...
namespace PhotonTheme.Utilities.Converters
{
    internal static class ShadowInfo
    {
        ...
        static ShadowInfo()
        {
            var resourceDictionary = new ResourceDictionary { Source = new Uri("pack://application:,,,/PhotonTheme;component/Themes/General/Shadows.xaml", UriKind.Absolute) };
