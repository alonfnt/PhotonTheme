...
using PhotonTheme.Shared.Extensions;
...
namespace PhotonTheme.Shared.Converters
{
    internal static class ShadowInfo
    {
        ...
        static ShadowInfo()
        {
            var resourceDictionary = new ResourceDictionary { Source = new Uri("pack://application:,,,/PhotonTheme.Shared;component/Themes/PhotonTheme.Shadows.xaml", UriKind.Absolute) };
